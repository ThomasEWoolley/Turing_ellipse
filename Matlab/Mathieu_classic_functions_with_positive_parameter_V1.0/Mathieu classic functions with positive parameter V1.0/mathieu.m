function csf=mathieu(kf,m,q,xr,csf,varargin);
%     ===============================================================
...
%     x   --- Vector Argument of Mathieu functions(in radian)
...
ic=fix(fix(m)./2)+1;
%====================================================
%computate the angular mathieu function
%====================================================
csf=0.0d0;
for  k=1:km;
if(kd == 1);
...
if(abs(1.0-x1./(x+eps))< eps|f == 0.0)break; end;
x0=x1;
f0=f1;
x1=x;
f1=f;
