...
par=           [ 2   , 1  ,  10  ,  1/10   , 9/10]; % Parameters used in functions and Jacobian
...
sw.sym=2;
pde=stanpdeo1D(1,0.004); % PDE setup
...
p.nc.lammax=2.7; % Max parameter value
...
r=[Du*K/L^2 0*K; 0*K Dv*K/L^2]*[U;V]-p.mat.M*f;
end
